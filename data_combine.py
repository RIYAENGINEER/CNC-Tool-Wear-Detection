...
df_train = pd.read_csv(f'C:\\Users\\Priyadharshini\\Documents\\CNC\\train.csv')

total = 0
for i in range(1,10):
    globals()['df_%s' % i] = pd.read_csv(f'C:\\Users\\Priyadharshini\\Documents\\CNC\\experiment_0{i}.csv')
    total = total + globals()['df_%s' % i].shape[0]

for i in range(10,19):
    globals()['df_%s' % i] = pd.read_csv(f'C:\\Users\\Priyadharshini\\Documents\\CNC\\experiment_{i}.csv')
    total = total + globals()['df_%s' % i].shape[0]
...
# Save the Dataset
df.to_csv(f'C:\\Users\\Priyadharshini\\Documents\\CNC\\aggregated_data.csv', index=False)